...
public class EmployeeActionControllerTest {
  ...
  private static final List<Employee> employees =
      new ArrayList<Employee>(asList(employee1, employee2));
  ...
  public void listsEmployees() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.INFO, "Listing 2 employees...")
        .withExpectedEvent(Level.DEBUG, employee1.toString())
        .withExpectedEvent(Level.DEBUG, employee2.toString()).verifyCalls();
  ...
  public void getsAddEmployeeForm() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.INFO, "Setting up \"Add Employee\" form")
        .verifyCalls();
  ...
  public void addsEmployee() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.INFO, "Adding employee:")
        .withExpectedEvent(Level.INFO, employee1.toString()).verifyCalls();
  ...
  public void deletesEmployee() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.WARN, "Deleting employee with ID 3")
        .verifyCalls();
  ...
  public void getsUpdateEmployeeForm() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.INFO, "Setting up Employee Update form")
        .verifyCalls();
  ...
  public void updatesEmployee() {
    ...
    new LogbackEventChecker().withExpectedEvent(Level.INFO, "Updating employee with details:")
        .withExpectedEvent(Level.INFO, employee1NewDetails.toString()).verifyCalls();
