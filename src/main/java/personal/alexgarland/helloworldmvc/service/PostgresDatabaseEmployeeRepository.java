...
public final class PostgresDatabaseEmployeeRepository extends AbstractDatabaseEmployeeRepository {
	...
	@Override
	protected Employee addEmployeeWithPreparedStatement(PreparedStatement ps, Employee e) throws SQLException {
	...
	@Override
	protected  List<Employee> getEmployeeListWithPreparedStatement(PreparedStatement ps) throws SQLException {
	...
	@Override
	protected Integer deleteEmployeeWithPreparedStatement(PreparedStatement ps, int employeeId) throws SQLException {
	...
	@Override
	protected Integer updateEmployeeWithPreparedStatement(PreparedStatement ps, Employee e) throws SQLException {
		ps.setString(1, e.getFirstName());
		ps.setString(2, e.getLastName());
		ps.setString(3, e.getNickName());
		ps.setInt(4, e.getId());
	...
	@Override
	protected Employee getEmployeeByIdWithPreparedStatement(PreparedStatement ps, int employeeId) throws SQLException {
		ps.setInt(1, employeeId);
		try (ResultSet rs = ps.executeQuery()) {
			rs.next();
			String firstName = rs.getString("first_name");
